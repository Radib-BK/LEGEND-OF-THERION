...
public class BlueSlime extends Entity {
    ...
    public void getEnemyImage() {
        try {
            ...
            left1 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/left/0.png"));
            left2 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/left/1.png"));
            left3 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/left/2.png"));
            left4 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/left/3.png"));
            right1 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/right/0.png"));
            right2 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/right/1.png"));
            right3 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/right/2.png"));
            right4 = ImageIO.read(getClass().getClassLoader().getResourceAsStream("Enemy/Blue Slime/walk/right/3.png"));
    ...
    public void draw(Graphics2D g2) {
        ...
        if(can_get_hit%2==0 && dying_animation<2 )
            g2.drawImage(current_image, x, y+ 56- sprite_height[spriteNum-1], width, sprite_height[spriteNum-1], null);
