...
public class AssetSetter {
    ...
    public void set_enemy()
    {
        ...
        gp.enemy[7][0]= new CaveSlime(gp);
        set_enemy_parameter(gp.enemy[7][0], 400, 635, 200, 700);

        gp.enemy[7][1]= new CaveSlime(gp);
        set_enemy_parameter(gp.enemy[7][1], 1000, 635, 750, 1350);

        gp.enemy[7][2]= new BlackMetal(gp);
        set_enemy_parameter(gp.enemy[7][2], 100, 165, 450, 1300);
        gp.enemy[7][2].speed=6;

        for(int i=0; i<gp.enemy[7][2].lifetime_max_charge; i++)
            gp.enemy[7][2].bullet[i].speed=10;
